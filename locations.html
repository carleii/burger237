...
<html lang="en" dir="rtl">
	...
	<body>
		...
		<header id="header-3" class="header navik-header header-transparent header-shadow">
			<div class="container">
				...
				<div class="navik-header-container">
					...
					<!-- CALL BUTTON -->
				    <div class="callusbtn text-right"><a href="tel:123456789"><i class="fas fa-phone"></i></a></div>

					
					<!-- LOGO IMAGE -->
	                <div class="logo" data-mobile-logo="images/logo-01.png" data-sticky-logo="images/logo-01.png">
	                	<a href="demo-1.html"><img src="images/logo-01.png" alt="header-logo"/></a>
					</div>
		...
		<div id="page" class="page">
			...
			<!-- PAGE HERO
			============================================= -->	
			<div id="locations-page" class="page-hero-section division">
				<div class="container">	
					<div class="row">	
						<div class="col-lg-12">
						...
						<div class="col-md-6 col-lg-4">
							<div class="cbox-3 text-center">
								...
								<div class="cbox-3-txt">
									...
									<!-- Phone -->	
									<h6 class="h6-xl">Phone: <span><a href="tel:123456789">789-654-3210</a></span></h6>
						...
						<div class="col-md-6 col-lg-4">
							<div class="cbox-3 text-center">
								...
								<div class="cbox-3-txt">
									...
									<!-- Phone -->	
									<h6 class="h6-xl">Phone: <span><a href="tel:123456789">789-456-0123</a></span></h6>
						...
						<div class="col-md-6 col-lg-4">
							<div class="cbox-3 text-center">
								...
								<div class="cbox-3-txt">
									...
									<!-- Phone -->	
									<h6 class="h6-xl">Phone: <span><a href="tel:123456789">789-645-0123</a></span></h6>
				...
				<div class="container">
					<div class="inner-bg bg-lightgrey">
						<div class="row">
							...
							<!-- NEWSLETTER FORM -->
							<div class="col-md-10 col-xl-8 mr-auto ml-auto">
					...
					<div class="row">
						...
						<div class="col-md-6 col-lg-4 col-xl-3">
							<div class="footer-contacts mb-40">
								...
								<!-- Contacts -->
								<p class="foo-email txt-500 mt-15"><a href="mailto:yourdomain@mail.com">hello@yourdomain.com</a></p>
								<p><span class="yellow-color"><a href="tel:123456789">789-654-3210</a></span></p>
